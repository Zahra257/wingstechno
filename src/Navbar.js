...
const Navbar = () => {
   ...
   const onLogout = (e) => {
    ...
    return(
<div style={{"display" : 'flex', "alignItems": 'center',"justifyContent": 'space-between ','backgroundColor': 'white', 'padding':'10px'}}>
         ...
         <div style={{'marginRight':'101px'}}>
            <Link to='/' style={{'textDecoration': "none", 'marginRight' :'20px'}}><b>Home</b> </Link>
               <Link to='/Posts' style={{'textDecoration': "none"}}> <b style={{'color' :'#ed0c39', }}>Posts </b> </Link>
               <button style={{'backgroundColor' : '#ed0c39','border': "none",'color': "white",'padding': "10px 30px  ",'textAlign': "center",'textDecoration': "none",'fontSize': "16px",'borderRadius':'10px',  'alignItems':'center','marginLeft' :'20px'}}onClick={onLogout}>
               Logout
            </button>
         </div> </> ): <>
